...
export default function Hero() {
    return (
        <section id="home" className="relative min-h-[85vh] flex items-center justify-center pt-28 pb-12 px-4 overflow-hidden bg-[#09090B]">
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
                ...
                >
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="#projects" className="px-10 py-4 bg-sky-600 text-white rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-sky-500 hover:shadow-lg hover:shadow-sky-500/20 transition-all active:scale-95 cursor-pointer">
                            My Work <ArrowRight className="w-4 h-4" />
                        </a>
                        <a
                            href="/api/download-cv?type=cv&mode=preview"
                            target="_blank"
                            className="px-10 py-4 border border-white/10 text-white bg-white/5 rounded-xl font-bold text-sm flex items-center gap-2 hover:bg-white/10 transition-all backdrop-blur-md active:scale-95 cursor-pointer"
                        >
                            <Eye className="w-4 h-4" /> My Resume
                        </a>
                    </div>
                    ...
                    <div className="mt-10 flex items-center gap-8 border-t border-white/5 pt-10">
                        ...
                        <div>
                            ...
                            <div className="text-[10px] text-slate-500 font-bold uppercase tracking-widest mt-1">Key Clients</div>
                        </div>
                        <div>
